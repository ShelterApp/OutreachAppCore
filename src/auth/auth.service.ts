...
export class AuthService {
    ...
    async login(user: any) {
        const payload = { name: user.name, email: user.email, phone: user.phone, id: user.id, userType: user.userType, organizationId: user.organizationId, regionId: user.regionId }
        return {
